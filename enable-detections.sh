...
echo "  1. Ship the logs:  bash logpush-to-s1.sh   (firewall_events + http_requests → S1 HEC)"
echo "  2. Deploy the OCSF parser (marketplace-cloudflare-latest) + the STAR rules in S1,"
